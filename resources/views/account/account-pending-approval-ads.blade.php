                    ...
                    <div class="inner-box">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="addManageTable"
                                ...
                                <tbody>
                                @foreach($unApprovedAds as $unApprovedAd)
                                <tr>
                                    ...
                                    <td style="width:14%" class="add-img-td"><a href="<?php echo asset('/ad-details/');?><?php echo "/".$unApprovedAd->adid; ?>"><img
                                            class="thumbnail  img-responsive"
                                    src="<?php echo asset('assets/thumbnail.php?adid=')?><?php echo $unApprovedAd->adid;?>"
                                            alt="img"></a></td>
                                    <td style="width:58%" class="ads-details-td">
                                        <div>
                                            <p><strong> <a href="<?php echo asset('/ad-details/');?><?php echo "/".$unApprovedAd->adid; ?>" title="Brend New Nexus 4">{{$unApprovedAd->title}}</a> </strong></p>
                                    ...
                                    <td style="width:16%" class="price-td">
                                        <div><strong>R {{$unApprovedAd->price}}</strong></div>
                                    </td>
                                    <td style="width:10%" class="action-td">
                                        <div>
                                            <p><a class="btn btn-primary btn-xs edit-ad"> <i class="fa fa-edit"></i> Edit </a>
                                            </p>

                                            <p><a class="btn btn-danger btn-xs delete" id="{{ $unApprovedAd->adid}}"> <i class=" fa fa-trash"></i> Delete
                                            </a></p>
                                        </div>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      $('.edit-ad').click(function(){
            alert('You can only edit this ad once it has been approved');
    });
      ...
      $('.delete').click(function(){
        ...
        var id = $(this).attr('id') 
          ...
          if (r == true) {
            path = "{{ url('delete-unapproved-ad') }}"+"/"+id;
             $.ajax({
                url: path,
                type: 'GET',
                data: {id:id},
