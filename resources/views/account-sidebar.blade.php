                            ...
                            <div class="user-panel-sidebar">
                                ...
                                <div class="collapse-box">
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse in">
                                        <ul class="acc-list">
                                            <li class="active"><a href="{{ url('/account-myads') }}"><i class="icon-docs"></i> My
                                                ads <span class="badge"><?php echo count($userAds); ?></span> </a></li>
                                            <li><a href="{{ url('/account-favourite-ads') }}"><i class="icon-heart"></i>
                                            ...
                                            <li><a href="{{ url('/account-pending-approval-ads') }}"><i
