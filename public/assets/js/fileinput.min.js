...
!function (e) {
    ...
    b.prototype = {
        constructor: b, init: function (e) {
            ...
            return e.showUpload ? (e.isDisabled && (n = " disabled "), t = d(e.uploadUrl) || e.isDisabled ? '<button type="button" class="' + i + '"' + n + ">" + e.uploadIcon + e.uploadLabel + "</button>" : '<a href="' + e.uploadUrl + '" class="' + i + '"' + n + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        }
